...
sudo docker pull $4/storm-docker:latest && sudo docker run -d --restart always -e ZK_IPS=$1 -e ZK_ID=$2 -v $mountDir:/logs -v $dataDir:/data $3/storm-docker /zookeeper-3.4.8/bin/zkServer.sh start
